      ...
      <form action="procesa_datos.php" method="post">
            <div class="col-md-offset-5 col-md-3">
                  <div class="form-login">
                        <br>
            		<label for="usuario">Nombre de cliente:     <input type="text" name="nombredecliente" value="Juanjo" placeholder="nombre" /><br>
                        <label for="Dni">Dni<br><input type="text" name="dni" value=""  /><br><br>
                        <label for="Direccion">Dirección:     <input type="text" name="Direccion" value=""  /><br>
                        <label for="usuario">Pblación:     <input type="text" name="Poblacion" value=""  /><br>            
